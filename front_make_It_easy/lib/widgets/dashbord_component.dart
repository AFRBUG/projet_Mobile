 ...
 * @noteapi  la page dashbord est composé  par  des  dashbord component chaque  composante contient un Medicament
 */


Widget dashbordComponent(BuildContext context , Color color, Medication   medication ) {
 return   SizedBox(
    width:160.0,
    height: 160.0,
    child: Card(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        Medication medication=Medication(1,name,description,schedule) ;
